...
/**
 * Userfunction to determine if cal caching should be disabled
 * Working the same way that cal's user_isCalNotAllowedToBeCached does
 * @return boolean
 */
...
if (TYPO3_MODE == 'FE') {
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_activate', 'tx_register4cal_activate', array(
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_regstart', 'tx_register4cal_regstart', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_regend', 'tx_register4cal_regend', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_maxattendees', 'tx_register4cal_maxattendees', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_waitlist', 'tx_register4cal_waitlist', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_fieldset', 'tx_register4cal_fieldset', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_listreg', 'tx_register4cal_listreg', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
    ...
    t3lib_extMgm::addService($_EXTKEY, 'tx_register4cal_submit', 'tx_register4cal_submit', array(
        'title' => 'Extension Model for tx_register4cal fields', 'description' => '', 'subtype' => 'module',
        'available' => TRUE, 'priority' => 50, 'quality' => 50,
        'os' => '', 'exec' => '',
