...
if (TYPO3_MODE == 'FE') {
	...
	require_once(t3lib_extMgm::extPath($_EXTKEY).'hooks/class.tx_register4cal_hook1.php');
	$GLOBALS['TYPO3_CONF_VARS']['FE']['EXTCONF']['ext/cal/controller/class.tx_cal_controller.php']['finishViewRendering'][]='EXT:register4cal/hooks/class.tx_register4cal_hook1.php:tx_register4cal_hook1';
	...
	require_once(t3lib_extMgm::extPath($_EXTKEY).'hooks/class.tx_register4cal_hook2.php');
	$GLOBALS ['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['processDatamapClass'][] = 'EXT:register4cal/hooks/class.tx_register4cal_hook2.php:tx_register4cal_hook2';
}
