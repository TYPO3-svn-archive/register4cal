...
if (isset($confArr['fieldStoragePid'])) {
	...
	if ($fieldStoragePid != 0) $sPid = ' IN (###CURRENT_PID###,' . $fieldStoragePid . ' )';
}
...
$TCA['tx_register4cal_registrations'] = array(
	...
	'columns' => array(
		...
		'visible_for_other_users' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:register4cal/locallang_db.xml:tx_register4cal_registrations.visible_for_other_users',
			'l10n_mode' => 'exclude',
			'config' => array(
				'type' => 'check',
				'readOnly' => 1,
	...
	'types' => array(
		'0' => array('showitem' => 'cal_event_uid;;;;1-1-1, feuser_uid, status, numattendees, additional_data,visible_for_other_users')
	),
	'palettes' => array(
		'1' => array('showitem' => '')
	)
	...
	'columns' => array(
		...
		'fields' => array(
			...
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'tx_register4cal_fields',
				'foreign_table_where' => 'AND tx_register4cal_fields.sys_language_uid in (0,-1) AND tx_register4cal_fields.pid'.$sPid.' ORDER BY tx_register4cal_fields.name',
				'size' => 10,
				'minitems' => 1,
				'maxitems' => 20,
			)
