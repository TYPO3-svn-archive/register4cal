...
class tx_register4cal_pi1 extends tslib_pibase {
	...
	function main($content, $conf) {
		try {
			...
			if (!$pidlist) throw new Exception('There is no storage folder set for the plugin. Please notify the site administrator!');
			// No display mode is set --> throw exception
			if (!$displayMode) throw new Exception('There is no display mode set for the plugin. Please notify the site administrator!');
